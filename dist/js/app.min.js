...
angular.module('browse').controller('BrowseController', ["$scope", "$routeParams", "$location", "browseConfig", "csApi", "viewer", function($scope, $routeParams, $location, browseConfig, csApi, viewer) {
...
angular.module('browse').controller('ViewerController', ["$scope", "$modalInstance", "browseConfig", "csApi", "node", function($scope, $modalInstance, browseConfig, csApi, node) {
...
angular.module('browse').directive('browseIcon', ["$q", "$log", "csApi", function ($q, $log, csApi) {
...
angular.module('browse').service('viewer', ["$modal", function($modal) {
...
angular.module('csApi').controller('LoginController', ["$scope", "$modalInstance", "$timeout", "csApi", "ssoConfig", function($scope, $modalInstance, $timeout, csApi, ssoConfig) {
...
angular.module('csApi').factory('csApi', ["$rootScope", "$q", "csApiConfig", "Restangular", "csLogin", function($rootScope, $q, csApiConfig, Restangular, csLogin) {
...
angular.module('csApi').service('csLogin', ["$modal", function($modal) {
...
angular.module('csDumb').config(["$routeProvider", function($routeProvider) {
...
angular.module('csDumb').run(["appConfig", "browseConfig", "csApiConfig", function(appConfig, browseConfig, csApiConfig) {
...
angular.module('csDumb').controller('AppController', ["$scope", "appConfig", function($scope, appConfig) {
