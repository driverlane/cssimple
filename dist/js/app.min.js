...
angular.module('browse').controller('BrowseController', ["$scope", "$routeParams", "$location", "csApi", "viewer", function($scope, $routeParams, $location, csApi, viewer) {
...
angular.module('browse').controller('ViewerController', ["$scope", "$modalInstance", "csApi", "node", function($scope, $modalInstance, csApi, node) {
...
angular.module('browse').directive('browseIcon', ["$q", "csApi", function ($q, csApi) {
...
angular.module('csApi').factory('csApi', ["$rootScope", "$q", "Restangular", "csLogin", function($rootScope, $q, Restangular, csLogin) {
...
angular.module('wrApi').factory('wrApi', ["$q", "$http", function($q, $http) {
